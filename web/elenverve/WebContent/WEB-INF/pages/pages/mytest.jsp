										...
										<div class="tp-banner-container">
												<div class="tp-banner" >
													...
													<li data-transition="slideleft" data-slotamount="7" data-masterspeed="700" >
														<img src="<%=request.getContextPath()%>/resources/images/deal-week.jpg"  alt="slidebg1"   data-bgfit="cover" data-bgposition="left top" data-bgrepeat="no-repeat" />
														<div class="tp-caption skewfromright" data-x="680" data-y="252" data-speed="2000" data-start="800" data-easing="Back.easeOut" data-endspeed="500" data-captionhidden="on" style="font-size:40px; z-index: 4">
															<ul class="slide3-list">
																<li><i class="fa fa-shopping-cart"></i><span>SHOP NOW</span></li>
					...
					<div class="col-md-6">
						<div class="best-seller most-sold">
							<div class="sold-thumb">
								...
								<img src="<c:url value="/resources/images/Product1/DSC_1334.jpg"/>" alt="" />
					...
					<div class="col-md-6">
						<div class="best-seller most-sold">
							<div class="sold-thumb">
								...
								<img src="<c:url value="/resources/images/Product1/DSC_1335.jpg"/>" alt="" />
								<!--<img alt="" src="http://placehold.it/248x273">-->
								<a href="single-post.html" title="">VIEW DETAILS</a>
								<i class="box1"></i>
								<i class="box2"></i>
		...
		<div class="shoping-categories">	
			<div class="row">
				<div class="col-md-4">
					...
					<img src="<%=request.getContextPath()%>/resources/images/Collection/DSC_1336.jpg" alt="" />
				...
				<div class="col-md-4">
					<div class="shop-categories-sec">
						...
						<img src="<%=request.getContextPath()%>/resources/images/Collection/DSC_1335.jpg" alt="" />
						<!--<img src="http://placehold.it/367x360" alt="" />-->
						<div class="shop-categories">
							<h2>CONTINENTS</h2>
							<a href="#" title="">VIEW ALL</a>
				...
				<div class="col-md-4">
					<div class="shop-categories-sec">
						...
						<img src="<%=request.getContextPath()%>/resources/images/Collection/DSC_1337.jpg" alt="" />
						<!--<img src="http://placehold.it/367x360" alt="" /> -->
						<div class="shop-categories">
							<h2>SPECTRUM</h2>
							<a href="#" title="">VIEW ALL</a>
				...
				<div class="row">
					<div class="col-md-4">
						<div class="shop-recent-product">
							...
							<!-- <img src="<%=request.getContextPath()%>/resources/images/recent-products.jpg" alt="" /> -->
							<img src="<%=request.getContextPath()%>/resources/images/Category/DSC_1334.jpg" alt="" />
								<span><i>$30</i></span>
							<p>HOME DECOR</p>
							<ul>
					...
					<div class="col-md-4">
						<div class="shop-recent-product">
							<!--<img src="http://placehold.it/368x381" alt="" /> -->
							<!--  <img src="<%=request.getContextPath()%>/resources/images/recent-products3.jpg" alt="" /> -->
							<img src="<%=request.getContextPath()%>/resources/images/Category/DSC_1335.jpg" alt="" />
								<span><i>$30</i></span>
					...
					<div class="col-md-4">
						<div class="shop-recent-product">
							<!--<img src="http://placehold.it/368x381" alt="" /> -->
							<!-- <img src="<%=request.getContextPath()%>/resources/images/recent-products3.jpg" 	alt="" /> -->
							<img src="<%=request.getContextPath()%>/resources/images/Category/DSC_1336.jpg" alt="" />
								<span><i>$30</i></span>
					...
					<div class="col-md-4">
						<div class="shop-recent-product">
							<!--<img src="http://placehold.it/368x381" alt="" /> -->
							<!--  <img src="<%=request.getContextPath()%>/resources/images/recent-products3.jpg"	alt="" /> -->
							<img src="<%=request.getContextPath()%>/resources/images/Category/DSC_1337.jpg" alt="" />
								<span><i>$30</i></span>
							<p>LAMP SHADES</p>
							<ul>
								<li><a href="#" title="">Add To Cart</a></li>
