			...
			<div class="row">
				<div class="col-md-9">
								...
								<div class="col-md-4 inner-products">
									<c:forEach items="${prodList}" var="prod">
										<div class="best-seller most-sold">
											<div class="sold-thumb">
												...
												<img src="<%=request.getContextPath() %>${prod.imgUrl}"
													alt="">
												<c:if test="${prod.detailLinkInd >0}">
													<a href="single-post.html" title="">VIEW DETAILS</a>
												</c:if>
												<i class="box1"></i> <i class="box2"></i> <i class="box3"></i>
												<i class="box4"></i>
											</div>
									...
									-->
												<c:if test="${prod.cartInd >0}">
													<li class="cart"><a title="" href="#"><i
															class="fa fa-heart"></i></a></li>
												</c:if>
												<c:if test="${prod.favInd >0}">
													<li class="shop"><a title="" href="#"><i
					...
					<div class="custom-pagination">
						...
						<span><i>Pages 1 of 2</i></span> <a href="#" title=""><span>Next
								Page</span></a> <a href="#" title=""><span>Previous</span></a>
					</div>
				</div>
				...
				<div class="col-md-3">
						...
						<div class="tab-content" id="myTabContent">
							<div id="recent" class="tab-pane fade in active">
								<div class="tab-recent" id="tab-recent">
									<ul>
										<li><span><img src="http://placehold.it/85x106"
												alt="" /></span>
											<h3>
												<a href="#" title="">Envato’s Most Wanted: BuddyPress</a>
											</h3>
					...
					<div class="widget-body range-slider">
						<div class="heading-5">
							<h2>
								<i class="fa fa-folder-open"></i>PRICE RANGE
							</h2>
						</div>
					...
					<div class="widget-body">
						<div class="heading-5">
							<h2>
								<i class="fa fa-folder-open"></i>DISCOUNT PRODUCT
							</h2>
						</div>
