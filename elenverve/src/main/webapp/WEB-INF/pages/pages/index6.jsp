		...
		<div class="row">
			<div class="col-md-6">
				<div class="best-seller most-sold">
					<div class="sold-thumb"><img alt="" src="http://placehold.it/548x273"><a href="single-post.html" title="">VIEW DETAILS</a>
						<i class="box1"></i>
						<i class="box2"></i>
						<i class="box3"></i>
						<i class="box4"></i>
			...
			<div class="col-md-3">
				<div class="best-seller most-sold">
					<div class="sold-thumb"><img alt="" src="http://placehold.it/247x272"><a href="single-post.html" title="">VIEW DETAILS</a>
						<i class="box1"></i>
						<i class="box2"></i>
						<i class="box3"></i>
						<i class="box4"></i>
...
<section class="block remove-gap all-remove-gap">
	<div class="container">
		<div class="row">
...
<script src="<c:url value="/resources/js/jquery-1.10.2.js"/>"></script><!-- Jquery -->
<script src="<c:url value="/resources/js/script.js"/>"></script><!-- Common -->
<script type="text/javascript"  src="<c:url value="/resources/js/bootstrap.min.js"/>"></script><!-- Bootstrap -->
<script type="text/javascript"  src="<c:url value="/resources/js/modernizr.js"/>"></script><!-- modernizr -->
<script type="text/javascript"  src="<c:url value="/resources/js/owl.carousel.min.js"/>"></script><!-- Owl Carousal -->
<script type="text/javascript"  src="<c:url value="/resources/js/onscreen.js"/>"></script><!-- On Screen -->
 


<!-- SLIDER REVOLUTION -->
<script type="text/javascript" src="<c:url value="/resources/js/jquery.themepunch.plugins.min.js"/>"></script>
<script type="text/javascript" src="<c:url value="/resources/js/jquery.themepunch.revolution.min.js"/>"></script>
