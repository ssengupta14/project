...
<body>
	...
	<div class="tp-banner-container">
							...
							<c:forEach begin="1" end="4" varStatus="loop" var="column">
								<div class="col-md-3">
									...
									<div class="best-seller1 seller9">
										<img class="seller-still" alt="" src="<%=request.getContextPath()%>${model.collections.get(row*column).image}"> 
										 <img class="seller-hover" alt="" src="<%=request.getContextPath()%>${model.collections.get(row*column).image}">
		...
		<Section class="block">
			<div class="heading7">
				<h2>
					<i>SHOP BY OUR EXCLUSIVE CATEGORIES</i>
				</h2>
							...
							<c:forEach begin="1" end="4" varStatus="loop" var="column">
								<div class="col-md-3">
									...
									<div class="best-seller seller2">
										<img class="seller-still" alt=""
											src="<%=request.getContextPath()%>${model.categories.get(row*column).image}"> <img  class="seller-hover" alt="" 	src="<%=request.getContextPath()%>${model.categories.get(row*column).image}">
		...
		<section class="block">
			<div class="container">
				...
				<a href="#" title=""><img src="<%=request.getContextPath()%>/resources/images/static-banner1.jpg" alt="" />
			</div>
	...
	<section class="block">
			<div class="container">
				<div class="row">
					...
					<div class="col-md-4">
						<a href="#" title=""><img src="<%=request.getContextPath()%>/resources/images/static-banner2.jpg" alt="" />
					</div>
					<div class="col-md-4">
						<a href="#" title=""><img src="<%=request.getContextPath()%>/resources/images/static-banner2.jpg" alt="" />
					</div>
